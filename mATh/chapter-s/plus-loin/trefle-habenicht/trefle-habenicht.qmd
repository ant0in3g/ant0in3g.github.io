...
Nous allons étudier le Trèfle de Habenicht définie par son équation polaire. Son équation polaire est 
$$\rho = 1 +\cos\left(n\theta\right) + \sin^2\left(n\theta\right)$$
L'objectif est de tracer le *Trèfle de Habenicht* pour $n = 3$ ou $n = 4$, selon la chance espérée ! 🍀
...
On peut à présent étudier les tangentes particulière en 
