...
:::
::: {#second-column}
[![](R_RStudio_LogoS-rbg.png)](https://ant0in3g.github.io/sTa7/tuto_R_RStudio/index.html)
:::
:::
...
## Groupes et Bases de données

Vous pouvez retrouver vos groupes via ce [lien](https://istom-my.sharepoint.com/:x:/g/personal/a_gere_istom_fr/EfDC-anXaN5GrmSWTYKLv2kBMCqk5JEZPhNnL7TDfUxjWg?e=NJLtnA).

Les bases de données seront bientôt disponibles.
